                  ...
                  <tr key={index}>
                    ...
                    <td scope="col" class="px-6 py-3">
                        <button type="button" onClick={() => handleDetailsClick(index)}>
                            <svg class="w-6 h-6 text-blue-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 14">
                                ...
                                >
                                    ...
                                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                        ...
                                        <div>
                                            <h2 classN>Detail:</h2>
                                                <ul>
                                                    <li>ID : {responses.indexOf(selectedResponse) + 1}</li>
                                                    <li>Name : {selectedResponse.name}</li>
                                                    <li>Date Of Birth : {selectedResponse.dateOfBirth}</li>
                                                    <li>Address : {selectedResponse.address}</li>
                                                </ul>
                                            </div>
                                            )}
                                        </div>
